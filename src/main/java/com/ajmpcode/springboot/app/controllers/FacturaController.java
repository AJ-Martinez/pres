...
import com.ajmpcode.springboot.app.models.entity.ItemFactura;
...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id, Model model, RedirectAttributes flash) {
		...
		if(factura == null) {
			flash.addAttribute("error", "La Factura no exite!");
	...
	@PostMapping("/form")
	public String guardar(@Validated Factura factura, RedirectAttributes flash, SessionStatus status, BindingResult result, Model model,
